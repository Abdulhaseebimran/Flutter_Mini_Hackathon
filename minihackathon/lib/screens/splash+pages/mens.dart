...
class Mens_ppage extends StatefulWidget {
  const Mens_ppage({Key? key}) : super(key: key);

  @override
  State<Mens_ppage> createState() => _MensState();
}

class _MensState extends State<Mens_ppage> {
  @override
          ...
          Row(
            ...
            children: [
             const Padding(padding: EdgeInsets.all(8.0),
              child: Image(image: AssetImage("assets/images/Oval7.png")),
              ),
              Column(
                children: [
                  Text("Alero Samuel",
                 ...
                 const Text("Designer at toki designs",
                  style: TextStyle(
